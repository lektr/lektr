...
- **Mobile Search** - Magnifying glass on desktop hidden correctly; mobile search overlay now uses full width
- **Mobile Navigation** - Logo link z-index fix to ensure clickability
- **List View** - Checkbox styling consistency

### Changed

- **Homepage** - Redesigned site homepage to better target lifelong learners and students
